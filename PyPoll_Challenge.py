...
winning_candidate = ""
winning_count = 0
    #winning_percentage refers to the winning percentage for candidates; winning1_percentage refers to the highest total for county votes
winning_percentage = 0


# 2: Track the largest county and county voter turnout.
county_with_largest_turnout=""
votes_in_largest_county_turnout = 0
winning1_percentage = 0
